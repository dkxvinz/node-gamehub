...
exports.router.post("/register", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [result] = yield dbconnect_1.default.query(sql, values);
        const header = result;
...
exports.router.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [rows] = yield dbconnect_1.default.query(sql, [email]);
        const users = rows;
        if (users.length === 0) {
        ...
        if (user.email === "admin@gmail.com") {
            ...
            isMatch = yield bcryptjs_1.default.compare(password, user.password);
        }
        if (!isMatch) {
            return res.status(401).json({ message: "Invalid email or password" });
        }
...
exports.router.put("/:id", auth_middleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield dbconnect_1.default.query(sql, values);
